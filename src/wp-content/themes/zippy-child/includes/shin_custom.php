			...
			<div class="available-infor" color="#0C62CA">
				<div class="available-infor-details">
					<div class="left-available-infor-details">
						<svg width="18px" height="18px" viewBox="0 0 35 35">
							<title>Information</title>
							<g transform="translate(-2 -2)" fill="none" fill-rule="evenodd">
								<rect width="39" height="39" rx="5"></rect>
								<path d="M19.5 34.5c-8.271 0-15-6.729-15-15s6.729-15 15-15 15 6.729 15 15-6.729 15-15 15m0-32.5C9.85 2 2 9.85 2 19.5S9.85 37 19.5 37 37 29.15 37 19.5 29.15 2 19.5 2m0 7.5a1.877 1.877 0 0 0-1.875 1.875c0 1.034.841 1.875 1.875 1.875a1.877 1.877 0 0 0 1.875-1.875A1.877 1.877 0 0 0 19.5 9.5m0 6.875c-1.035 0-1.875.84-1.875 1.875v7.5a1.876 1.876 0 0 0 3.75 0v-7.5c0-1.035-.84-1.875-1.875-1.875" fill="#0C62CA"></path>
							</g>
						</svg>
					</div>
