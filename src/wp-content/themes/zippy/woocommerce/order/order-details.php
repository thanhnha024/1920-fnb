		...
		<tfoot>
			<tr>
				...
				<td>
					...
					?>
					<?php if ($store->name_store) : ?>
						<p><?php echo esc_html($store->name_store); ?></p>
					<?php endif; ?>
					<?php if ($store->location_store) : ?>
			...
			foreach ($order->get_order_item_totals() as $key => $total) {
				$label_class = esc_html($total['label']);
				$label_class = str_replace(':', '', $label_class);
				$label_class = strtolower($label_class);

			?>
				<tr class="<?php echo $label_class; ?>">
