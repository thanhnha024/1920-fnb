	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<?php if ($store) : ?>
			<tr class="woocommerce-pickup-location">
				<td colspan="2">
					<h4 class="text-start fs-13px ">Store PickUp</h4>
					<p class="text-start text-secondary "><?php echo esc_html($store->name_store); ?></p>
					<p class="text-start text-secondary "><?php echo esc_html($store->location_store); ?></p>

				</td>
			</tr>
		<?php endif; ?>
		<?php if ($store) : ?>
			<tr class="woocommerce-pickup-time">
				<td colspan="2">
					<h4 class="text-start fs-13px ">Time PickUp</h4>
					<p class="text-start text-secondary "><?php echo esc_html($date); ?></p>
					<p class="text-start text-secondary "><?php echo esc_html($time); ?></p>
				</td>
			</tr>
		<?php endif; ?>
